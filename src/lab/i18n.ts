  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        promptHint:
          'למשל: חנות לספלי קרמיקה בעבודת יד, ארבעה דגמים, סיפור של היוצר על כל מוצר.',
      },
      {
        slug: 'ai-agent',
      ...
      },
      {
        ...
        promptHint:
          'למשל: סאונד אינטראקטיבי לאתר גלריה, אקורדים שמשתנים תוך כדי גלילה בין סקציות.',
      },
      {
        slug: 'game',
        ...
        promptHint:
          'למשל: משחק קטן ושיתופי לקמפיין מותג, לחיצה מהירה, טבלת שיאים, אפשרות לשתף תוצאה.',
      },
      {
        slug: 'realtime',
        ...
        promptHint:
          'למשל: דשבורד למחסן, תחנות, הזמנות פתוחות, התראה כשתחנה רגועה יותר מחמש דקות.',
      },
      {
        slug: 'mobile',
        ...
        promptHint:
          'למשל: אפליקציה לחובבי ציפורים, לוג של תצפית בשלוש הקשות, גרף ועוד מה נצפה בסביבה היום.',
      },
      {
        slug: 'other',
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        promptHint:
          'For example: a site for a ceramics studio, quiet, museum quality, with a gallery that feels like a viewing room.',
      },
      {
        slug: 'ecommerce',
      ...
      },
      {
        ...
        promptHint:
          'For example: a tool that takes a morning news headline and produces a short vertical video with narration and background footage.',
      },
      {
        slug: 'audio',
      ...
      },
      {
        ...
        promptHint:
          'For example: a shareable click to win small game for a brand campaign, leaderboard, share results, fast.',
      },
      {
        slug: 'realtime',
        ...
        promptHint:
          'For example: a warehouse dashboard, picking stations, open orders, alert when a station idles >5min.',
      },
      {
        slug: 'mobile',
        title: 'Mobile app',
