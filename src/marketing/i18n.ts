...
const HE: Dict = {
  ...
  cover: {
    ...
    standfirst:
      'במקום בריף שנמרח שבועות והצעת מחיר שגוררת התלבטויות — תיאור קצר של הרעיון בטופס, ואני אבנה POC ראשון על חשבוני. אם זה עובד — נמשיך לבנות יחד. אם לא — נפרדים בלי שום התחייבות.',
  ...
  contents: {
    ...
    title: 'מאיפה מתחילים',
    standfirst:
      'אלה סוגי הפרויקטים שאני בונה הכי הרבה. בחירה כאן פותחת את הבריף עם השדה המתאים כבר מסומן. אין התאמה? יש "אחר".',
    items: [
      {
        slug: 'mvp',
        title: 'MVP לסטארטאפ',
      ...
      },
      {
        ...
        summary:
          'יש רעיון מוזר מתחום שלא ראיתי? מצוין — הדברים הכי טובים שעבדתי עליהם התחילו ככה. אז לבריף.',
        fits: ['כל אחד'],
      },
    ],
    pickedLabel: 'נבחר',
  ...
  method: {
    ...
    title: 'איך בונים יחד',
    standfirst:
      'שלושה שלבים בלי הצעות מחיר ראשונות. בלי "הצעה מותאמת" של 14 עמודים. בלי לחתום על דבר לפני שיש משהו עובד לראות.',
    steps: [
      {
        num: '01',
        title: 'לתאר',
        body:
          'ממלאים בריף קצר. שלושה שדות חובה: סוג הפרויקט, הרעיון, ודרך ליצירת קשר. כל השאר אופציונלי. הבריף נשלח ישירות לוואטסאפ שלי כהודעה מסודרת — בלי שמירה בשרת, בלי "להירשם לניוזלטר", בלי שום שטויות.',
      },
      {
        num: '02',
        title: 'אבנה',
        body:
          'תוך 3–7 ימים אני בונה POC ראשון על חשבוני. לא Mockup. לא Figma. קוד עובד שאפשר לפתוח, ללחוץ, להראות למישהו, ולשאול אם זה הכיוון הנכון. אם לא — נפרדים כאן. בלי חשבון.',
      },
      {
        num: '03',
        title: 'לראות',
        body:
          'אם זה עובד — מדברים על המשך: scope ברור, מחיר ידוע מראש, אבני דרך שבועיות, ומסירה נקייה. אני לא עובד לפי שעות — לפי תוצאות.',
      },
    ],
    pullQuote: {
  ...
  about: {
    ...
    paragraphs: [
      ...
      'אני בונה כי זה היה התחביב לפני שזו הייתה פרנסה. אני מקבל החלטות מהירות כי הכי קל לתקן קוד שאיכשהו עובד, והרבה יותר קשה לתקן בריף שאף פעם לא הפך לקוד. זו הסיבה שאני עובד POC-first: ככה אני יודע מה לבנות, וברור בדיוק מה מקבלים.',
      'מבוסס בישראל, עובד עם לקוחות בכל העולם, בעברית ובאנגלית. עדיף לפנות אליי לפני בדיקה רוחבית של חברות תוכנה — אם זה לא מתאים, אגיד מראש.',
    ],
    stats: [
  ...
  brief: {
    number: '04',
    kicker: 'הבריף',
    title: 'מה רוצים לבנות',
    standfirst:
      'הבריף הזה נשלח ישירות לוואטסאפ שלי כהודעה מסודרת. ככל שיש יותר פירוט — POC ראשון מדויק יותר. גם 3 שורות מספיקות להתחיל.',
    requiredHint: 'חובה רק 3 שדות: סוג, רעיון, ודרך ליצירת קשר.',
    optionalHeading: 'עוד פרטים — אופציונלי',
    fields: {
      template: {
        label: 'סוג הפרויקט',
        placeholder: 'התבנית הקרובה ביותר — אפשר תמיד לעדכן אחר־כך',
      },
      idea: {
        label: 'הרעיון בקצרה',
      ...
      whyNow: {
        ...
        hint: 'מה השתנה שגרם לפנייה דווקא עכשיו? המידע הזה עוזר לי להבין דחיפות וקונטקסט.',
        placeholder: 'לדוגמה: "סיימנו סבב גיוס", "המתחרה השיק משהו דומה", או "התעייפתי לחכות".',
      },
      references: {
        label: 'משהו דומה שעובד טוב',
        placeholder: 'קישורים, צילומי מסך, או "כמו X אבל בלי Y"',
      },
      timeline: { label: 'מתי דרוש' },
      howHeard: {
        label: 'איך הגיע הקישור',
        placeholder: 'GitHub, מישהו שסיפר, פורטפוליו, חיפוש — מה שזכור',
      },
    ...
    marginalNote:
      'לא חובה למלא הכל. שלושה שדות מספיקים להתחיל. עברית? יופי. אנגלית? גם בסדר. קישור או צילום מסך? אפשר להוסיף בוואטסאפ אחרי שליחת הבריף.',
    mailFallback: 'מייל מתאים יותר? כאן',
    mailSubject: 'בריף חדש מהאתר',
    liveSuccess: 'נפתח וואטסאפ עם הבריף המסודר.',
    liveError: 'יש שדות חסרים. כדאי לבדוק את הסימונים האדומים.',
    briefHeading: 'היי בר,',
  ...
  qa: {
    ...
    items: [
      ...
      },
      {
        ...
        a:
          'מעולה — זה הרוב מהמקרים. שני משפטים על מה לא רצוי, או על בעיה יומיומית שכואבת, ואני אבנה את ההבנה הראשונה שלי. אחרי שרואים משהו, קל בהרבה להגיד "כן, אבל…" — וזה בדיוק מה שאני מחפש.',
      },
      {
  ...
  colophon: {
    number: '06',
    kicker: 'קולופון',
    title: 'נכון. הגענו עד לכאן.',
    pullQuote:
      'אז שווה לתאר את הרעיון במשפט אחד ולראות מה יוצא?',
    ctaPrimary: 'אל הבריף',
